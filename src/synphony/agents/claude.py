...
from synphony.agents.base import AgentEventCallback, AgentRunResult, AgentTurnRequest
...
class ClaudeBackend:
    ...
    def run_first_turn(
        ...
        return self._run_turn(request=request, resume_session_id=None, on_event=on_event)
